			...
			<div className="flex flex-wrap gap-4">
				...
				<AnchorLink href="#CONTACT" offset={80}>
					<CustomTextIconButton
						...
						styling="desktopXXL:h-20 desktopL:h-16 h-12 desktopXXL:w-52 desktopL:w-44 w-40 bg-gradient-to-br from-light-purple to-light-blue shadow-gray-200 hover:shadow-lg hover:shadow-gray-200 dark:outline dark:shadow-none dark:hover:shadow-none dark:outline-1 dark:hover:outline-2 dark:outline-white mx-left"
						rippleColor="bg-white"
					/>
				</AnchorLink>
			</div>
