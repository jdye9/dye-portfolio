	...
	return (
		...
		>
			<a href={url} rel="noreferrer" target="_blank">
				...
				<div className="p-5">
					<h5 className="mb-2 text-sm font-bold tracking-tight text-white mobileS:text-base mobileM:text-xl dark:text-[#1A1A40] desktopM:text-2xl desktopXL:text-3xl desktopXXL:text-4xl font-chakraPetch">
						{title}
					</h5>
					<p className="mb-3 text-xs font-normal text-white desktopXXL:text-2xl desktopXL:text-xl dark:text-[#1A1A40] mobileS:text-sm mobileM:text-base desktopM:text-lg font-chakraPetch">
						{description}
					</p>
				</div>
			</a>
